...
hint_label = tk.Label(
    hint_frame,
    text=(
        "Step 1: Select your source Excel file, output folder, and optionally set the 'Entry Size' limit.\n"
        ...
        "🔄 Resetting: If you want to run from the beginning, you must manually delete the '_progress.csv' file from your folder.\n"
        "⚡ Large Files: If your report contains 500+ rows, setting the 'Entry Size' limit to 500 is highly recommended for stable runs."
    ),
